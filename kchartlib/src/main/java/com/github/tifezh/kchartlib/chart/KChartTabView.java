...
//    TextView mTvFullScreen;
    ...
    private void init() {
        View view = LayoutInflater.from(getContext()).inflate(R.layout.kchart_layout_tab, null, false);
        LayoutParams layoutParams = new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewUtil.Dp2Px(getContext(), 30));
        view.setLayoutParams(layoutParams);
        addView(view);
        mLlContainer = (LinearLayout) findViewById(R.id.kchart_ll_container);
...
//        });
    ...
    public void addTab(String text) {
        View view = LayoutInflater.from(getContext()).inflate(R.layout.kchart_item_tab, null);
