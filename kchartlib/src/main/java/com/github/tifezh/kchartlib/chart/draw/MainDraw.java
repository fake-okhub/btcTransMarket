...
//        return point.getLowPrice();
    ...
    private void drawSelector(IKChartView view, Canvas canvas) {
        ...
        int precision = view.getPrecisionExchange(currencyType, exchangeType);
        strings.add("High : " + format(point.getHighPrice(), precision));
        strings.add("Low  : " + format(point.getLowPrice(), precision));
        strings.add("Open : " + format(point.getOpenPrice(), precision));
        strings.add("Close : " + format(point.getClosePrice(), precision));
