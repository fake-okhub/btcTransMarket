...
public class GridChartKView extends View {
	...
	private void drawLatitudes(Canvas canvas, int viewWidth, float latitudeSpacing ) {
		...
		//canvas.drawLine(0, UPER_CHART_TOP,viewWidth-DEFAULT_AXIS_MARGIN_RIGHT,UPER_CHART_TOP, paint);
		//canvas.drawLine(0, TITLE_HEIGHT,viewWidth-DEFAULT_AXIS_MARGIN_RIGHT,TITLE_HEIGHT, paint);
		//canvas.drawLine(0, MIDDLE_CHART_TOP-2*TITLE_HEIGHT-UPER_CHART_MARGIN_BOTTOM,viewWidth-DEFAULT_AXIS_MARGIN_RIGHT,MIDDLE_CHART_TOP-2*TITLE_HEIGHT-UPER_CHART_MARGIN_BOTTOM, paint);

		//canvas.drawLine(0, MIDDLE_CHART_TOP-TITLE_HEIGHT,viewWidth-DEFAULT_AXIS_MARGIN_RIGHT,MIDDLE_CHART_TOP-TITLE_HEIGHT, paint);
        //canvas.drawLine(0, MIDDLE_CHART_TOP-2*TITLE_HEIGHT,viewWidth-DEFAULT_AXIS_MARGIN_RIGHT,MIDDLE_CHART_TOP-2*TITLE_HEIGHT, paint);
		//canvas.drawLine(0, LOWER_CHART_TOP-TITLE_HEIGHT,viewWidth-DEFAULT_AXIS_MARGIN_RIGHT,LOWER_CHART_TOP-TITLE_HEIGHT,paint);
	 ...
	 paint.setColor(mLongiLatitudeColor);
		for (int i = 0; i <DEFAULT_UPER_LATITUDE_NUM; i++) {
			...
			//canvas.drawLine(0, UPER_CHART_TOP+latitudeSpacing * (i+1),viewWidth-DEFAULT_AXIS_MARGIN_RIGHT,UPER_CHART_TOP  + latitudeSpacing * (i+1), paint);
			if(axisYTitles!=null)
			{
				// 绘制Y刻度
		...
		for (int i = 0; i < DEFAULT_MIDDLE_LATITUDE_NUM; i++) {
			...
			//canvas.drawLine(0,MIDDLE_CHART_TOP+latitudeSpacing * i, viewWidth-DEFAULT_AXIS_MARGIN_RIGHT, MIDDLE_CHART_TOP+latitudeSpacing * i, paint);
		}
		...
		for (int i = 0; i <= DEFAULT_LOWER_LATITUDE_NUM; i++) {
			...
			canvas.drawPath(path, paint);
				...
				//canvas.drawLine(0,LOWER_CHART_TOP+latitudeSpacing * i, viewWidth-DEFAULT_AXIS_MARGIN_RIGHT, LOWER_CHART_TOP+latitudeSpacing * i, paint);
		}
	...
	public void notifyEventAll(GridChartKView chart) {
		if (null != notifyList) {
