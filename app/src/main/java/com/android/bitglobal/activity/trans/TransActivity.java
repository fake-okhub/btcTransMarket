...
//    LinearLayout ll_head_title;
    ...
    public static TransActivity activity;
...
//        }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        currencyType = getIntent().getExtras().getString("currencyType", "");
        exchangeType = getIntent().getExtras().getString("exchangeType", "");
...
//        assetList=new AssetList(context, DeviceUtil.dp2px(context,45.0f));
        assetList = new PopupDialog(this);
...
//                break;
            case R.id.headRightImage:
                ...
                UIHelper.showMarketDetailActivity(this, currencyType, exchangeType, coinLogoUrl);
                break;
